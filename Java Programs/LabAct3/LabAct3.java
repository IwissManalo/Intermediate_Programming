...
public class LabAct3
{
    ...
    public static void main(String[] args)
    {
        ...
        System.out.println("\033[1;34m" + "\nIntegers with significant digits in the first half of the list: " + newCollection1.size() + "\033[0m");
        System.out.print(newCollection1 + " ");

        System.out.println("\033[1;34m" + "\nIntegers with significant digits in the second half of the list: " + newCollection1.size() + "\033[0m");
    ...
    static void significanceDetector(Integer[] set1, Integer[] set2)
    {
        ...
        for (int num : set1)
        {
            String numStr = String.valueOf(num);
            String strippedNumStr = numStr.replaceAll("^0+|0+$", "");
            int sigSet1 = strippedNumStr.length();
            if (sigSet1 > 0) {
                System.out.println(num + " has " + sigSet1 + " significant digit(s)");
            }
        }
        ...
        for (int num : set2)
        {
            String numStr = String.valueOf(num);
            String strippedNumStr = numStr.replaceAll("^0+|0+$", "");
            int sigSet2 = strippedNumStr.length();
            if (sigSet2 > 0)
            {
                System.out.println(num + " has " + sigSet2 + " significant digit(s)");
            }
        }
